...
extern tyProc_9bXer9a4ps9aSGctILcxWReVw Dl_149630_;
extern tyProc_aO673xGTLLxou7P7GxoCXA Dl_149635_;
extern tyProc_im9buRnIvptJfzdASYMEbBA Dl_149801_;
...
extern tyProc_9cu0cWy2jNXKVhds9cs4T9a9cA Dl_150432_;
extern tyProc_hayl9b1HhJokJ1Zo9ctoglPg Dl_150434_;
extern tyProc_IwsYs9blTXXmAlfsBWq604w Dl_149818_;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nososErrorMsg)(void) {
	...
	nimln_(25, "oserr.nim");
	{
		...
		nimln_(28, "oserr.nim");
		{
			...
			nimln_(28, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_149635_(((NI32) 5119), NIM_NIL, err, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, osErrorMsg_yWvWz5V6Ib7QshcAbOiDeQ)(NI32 errorCode) {
	...
	nimln_(77, "oserr.nim");
	{
		...
		nimln_(80, "oserr.nim");
		{
			...
			nimln_(80, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_149635_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			nimln_(82, "oserr.nim");
			result = dollar__D2o4ABrO3iHTudww2CqX4w(msgbuf);
			nimln_(83, "oserr.nim");
...
static N_NIMCALL(void, TM_jvWQYw9bcuYhftfPX2ynPeg_42)(void) {
	NimThreadVars* NimTV_;
	NimTV_ = (NimThreadVars*) GetThreadLocalVars();
	nimGCvisit((void*)NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q, 0);
}
...
{	NimTV_ = (NimThreadVars*) GetThreadLocalVars();
	nimln_(33, "osenv.nim");
	{
		...
		NI16* e;
		NI32 T18_;
		if (!!(NimTV_->envComputed_OC1kQm9aRvX8VnmaXglp57Q)) goto LA3_;
		nimln_(34, "osenv.nim");
		unsureAsgnRef((void**) (&NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q), (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) newSeq((&NTI_sM4lkSb7zS6F7OVMvW9cffQ_), 0));
		nimln_(37, "osenv.nim");
		env = Dl_150432_();
		nimln_(38, "osenv.nim");
		e = env;
		...
		LA7_: ;
		{
			...
			while (1) {
				...
				NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV2(&(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q)->Sup, sizeof(NimStringDesc*));
				T12_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len++;
				T13_ = (NimStringDesc*)0;
				T13_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T12_]; NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T12_] = copyStringRC1(T11_);
				if (T13_) nimGCunrefNoCycle(T13_);
				nimln_(43, "osenv.nim");
		...
		T18_;
		nimln_(57, "osenv.nim");
		NimTV_->envComputed_OC1kQm9aRvX8VnmaXglp57Q = NIM_TRUE;
	}
	LA3_: ;
	}BeforeRet_: ;
	popFrame();
...
appendChar(T1_, 61);
	temp = T1_;
	{
		...
		colontmp_ = (NI)0;
		nimln_(93, "osenv.nim");
		T3_ = (NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q ? (NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len-1) : -1);
		colontmp_ = T3_;
		nimln_(2045, "system.nim");
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				{
					NIM_BOOL T8_;
					if ((NU)(i) >= (NU)(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len)) raiseIndexError();
					T8_ = (NIM_BOOL)0;
					T8_ = nsuStartsWith(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[i], temp);
					if (!T8_) goto LA9_;
					result = i;
					goto BeforeRet_;
				}
...
{	NimTV_ = (NimThreadVars*) GetThreadLocalVars();
	...
	nimln_(107, "osenv.nim");
	{
		...
		if ((NU)(i) >= (NU)(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len)) raiseIndexError();
		T5_ = (NI)0;
		T5_ = nsuFindChar(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[i], 61, ((NI) 0), ((NI) 0));
		TM_jvWQYw9bcuYhftfPX2ynPeg_45 = addInt(T5_, ((NI) 1));
		result = copyStr(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[i], (NI)(TM_jvWQYw9bcuYhftfPX2ynPeg_45));
		goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, putEnv_kCOmpbOSI9cdd36Ci11EFDw)(NimStringDesc* key, NimStringDesc* val) {
	...
	nimln_(135, "osenv.nim");
	{
		...
		if ((NU)(indx) >= (NU)(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len)) raiseIndexError();
...
appendString(T5_, val);
		asgnRefNoCycle((void**) (&NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[indx]), T5_);
	}
	goto LA1_;
	LA3_: ;
	{
...
appendString(T7_, val);
		NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q = (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV2(&(NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q)->Sup, sizeof(NimStringDesc*));
		T8_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len++;
		T9_ = (NimStringDesc*)0;
		T9_ = NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T8_]; NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[T8_] = copyStringRC1(T7_);
		if (T9_) nimGCunrefNoCycle(T9_);
		nimln_(139, "osenv.nim");
		T10_ = (NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q ? (NimTV_->environment_rnCB7Cc69bd2mlM49cn9czO2Q->Sup.len-1) : -1);
		indx = T10_;
	}
	LA1_: ;
