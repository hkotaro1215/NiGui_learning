...
extern tyProc_Tjolzh1w2dIIpj3oCDGPFw Dl_139629_;
extern tyProc_5HgIhqDabtYAePzjhB7xSA Dl_138804_;
...
N_LIB_PRIVATE N_NIMCALL(void, nossleep)(NI milsecs) {
	nimfr_("sleep", "os.nim");
	nimln_(1462, "os.nim");
	Dl_139629_(((NI32)chckRange(milsecs, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
	popFrame();
}
